...
public class Diversos {
	...
	public static void mostrarDados(String reposta, String titulo, boolean icone) {
		// se icone for V, ele vai fazer information, se não, error
	...
	public static DefaultFormatterFactory FormatoMascara(String titulo, int op) {
		// mascara vai colocar um prefix, tipo um formato nos numeros
		MaskFormatter mascara = null;
		try {
			switch (op) {
			case 0:
				mascara = new MaskFormatter("##/##/####"); // data
				break;
			case 1:
				mascara = new MaskFormatter("##:##"); // hora
				break;
			case 2:
				mascara = new MaskFormatter("(0##)-###-###"); // tel num
