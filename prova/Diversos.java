...
public class Diversos {
  ...
  public String leDados(String mensagem, String titulo){
  ...
  public boolean testaNum(String dado,String titulo){
      boolean teste;
  ...
  public boolean confirmar (String mensagem, String titulo){
      int resp = JOptionPane.showConfirmDialog(null,mensagem,titulo,JOptionPane.YES_NO_OPTION);
        return(resp == 0); 
  }

  public void mostrarDados(String resposta, String titulo, boolean icone){
     if(icone)
  ...
  public DefaultFormatterFactory FormatoData()
    {
  ...
  public boolean intervalo(double n, double n1, double n2, String titulo){
     if (n<=0){
